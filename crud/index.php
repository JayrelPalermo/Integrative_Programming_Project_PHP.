...
<body>
<div class="container">
    <h1 class="page-header text-center">M-duque Blog Management</h1>
    <div class="row">
        <div class="col-sm-10 col-sm-offset-1">

        <a href="#addnew" class="btn btn-primary" data-toggle="modal"><span class="glyphicon glyphicon-plus"></span> New Blog</a>

        <a href="http://localhost/marinduque/index.php#blog" class="btn btn-light" target="_blank"> View Website</a>   
        ...
        <table class="table table-sm table-striped table-condensed" style="margin-top:20px;">
            ...
            <tbody>
                ...
                $file = simplexml_load_file('file/index.xml');

                //loop through all the data and display each row
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td> <?php echo $rows->events; ?> </td>
                        <td> <?php echo $rows->restaurants; ?> </td>
